...
const ENEMY_FORMATIONS := {
	# 2 frontliners
	0: [Vector2i(8, 1), Vector2i(7, 4), Vector2i(8, 3), Vector2i(9, 6), Vector2i(7, 5)],
	1: [Vector2i(8, 1), Vector2i(7, 4), Vector2i(8, 3), Vector2i(9, 6), Vector2i(7, 5)],
	2: [Vector2i(8, 1), Vector2i(7, 4), Vector2i(8, 3), Vector2i(9, 6), Vector2i(7, 5)],
	3: [Vector2i(8, 1), Vector2i(7, 4), Vector2i(8, 3), Vector2i(9, 6), Vector2i(7, 5)],
